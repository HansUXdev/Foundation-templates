# Foundation for Apps Firebase Template
...
You'll need the following software installed to get started.
  ...
  * Also for good measure go ahead and install the [firebase cli](https://www.firebase.com/docs/hosting/command-line-tool.html) `npm install -g firebase-tools`
