# About
This is a collection of the basic templates (with client folders), firebase versions (fully working), and some new templates. This repo is also intended for educational purposes and more specifically to teach both myself and others how to work with foundation for apps. 


# F4A - using gulp-watch and livereload

Enables livereload on gulp-connect server and triggers it using gulp-watch. The advantage of gulp-watch over builtin watch is it will trigger on new file creation or file deletion.
